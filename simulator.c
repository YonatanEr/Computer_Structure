...
enum input_line {sim_exe, memin_txt, diskin_txt, irq2in_txt, memout_txt, regout_txt, trace_txt, hwregtrace_txt,cycles_txt, leds_txt, display7seg_txt, diskout_txt, monitor_txt};
