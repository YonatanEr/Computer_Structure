...
add     $t2,    $zero,  $imm,   255			                 #t2 = 255
bgt     $imm,   $s0,    $t2,    HALT	        	         #jump to HALT if square is overflowing (start_address+len>255)
